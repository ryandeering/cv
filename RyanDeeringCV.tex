...
\resumeItem{Handled functionality such as a login system for accounts with password hashing, image uploading, adding reviews to products, and an admin panel for the addition of products, accounts and to generate statistics based on products bought. }
\resumeItem{Implemented object-oriented programming practices such as inheritance and polymorphism for different types of accounts and products. An 'A' grade was awarded.}
\resumeItemListEnd 
\resumeSubHeadingListEnd
\vspace{-8pt}

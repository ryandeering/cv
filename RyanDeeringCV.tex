...
\resumeItem{Assisted in developing high-performance data processing pipeline using Azure Functions for orchestration and DuckDB for efficient data transformation and analysis.}

...
{\textbf{fotostor. - 4th Year Project} $|$ \emph{.NET 5, Blazor, IdentityServer, Selenium, Azure Pipelines test}}{October 2020 - April 2021}
\resumeItemListStart
...
\begin{itemize}[leftmargin=0.15in, label={}]
	\small{\item{
		...
		\textbf{Developer Tools}{: Visual Studio 2022, SQL Server Management Studio, Google Cloud Platform, Microsoft Azure, Android Studio} \\

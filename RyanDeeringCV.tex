...
\begin{itemize}[leftmargin=0.15in, label={}]
  \small{\item{
    ...
    \textbf{Technologies/Frameworks}{: .NET Core, Entity Framework Core, Microservices, Azure Functions, Blazor, Vue.js, Docker, OAuth2, Azure Queue Storage, DuckDB, Linux, xUnit, Moq, Sentry, Grafana, Application Insights, LINQ, OpenAPI/Swagger, Bicep} \\

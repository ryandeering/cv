...
\vspace{-12pt}
\resumeProjectHeading
{\textbf{Game Shop Project - 2nd Year Project} $|$ \emph{Java, Play Framework}}{January - April 2019}
\resumeItemListStart
\resumeItem{Team project of two developed over three months. E-commerce application based on a video game store.}
\resumeItem{Worked with Play Framework to handle frontend and Ebean to handle persistence of models in database.}
\resumeItem{Implemented object-oriented programming practices such as inheritance and polymorphism for different types of accounts and products.} 				    
\resumeItem{Handled functionality such as a login system for accounts with password hashing, image uploading, adding reviews to products, and an admin panel for the addition of products, accounts and to create statistics based on products bought. }
\resumeItemListEnd 
\resumeSubHeadingListEnd
\vspace{-8pt}
...
\begin{itemize}[leftmargin=0.15in, label={}]
	\small{\item{
		\textbf{Languages}{: C\verb|#|, Java, Python, C++,  HTML/CSS, JavaScript, SQL, Scala} \\
		\textbf{Developer Tools}{: Visual Studio 2019, IntelliJ Idea, Google Cloud Platform, Microsoft Azure, Android Studio} \\
		\textbf{Technologies/Frameworks}{:  .NET, Blazor, Linux, Docker, Git, Microsoft TFS, xUnit, jUnit, Play Framework} \\
	}}
\end{itemize}
\vspace{-8pt}
...
\resumeSubHeadingListStart
\resumeSubheading{Coder Dojo Teacher -- General Committee Member of the Computing Society}{Sept 2017 -- May 2017}{}{}
\resumeItemListStart
